    ...
    ($($future:expr),*) => {
        {
            ...
            $(
                ...
                match result {
                    ...
                    Err(_) => {
                        panic!("A future panicked during execution.");
                    }
                }
            )*
            results
...
fn main() {
    ...
    let outcome: Vec<u32> = try_join!(t_one, t_two);
    let outcome_two: Vec<()> = try_join!(t_four, t_three);
    println!("outcome: {:?}", outcome);
    println!("outcome_two: {:?}", outcome_two);
}
